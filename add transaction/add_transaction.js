...
post.onclick = () => {
    ...
    //     }
    //    })
    if (one.classList.contains('invalid') || one.value.lenght === 0 || two.classList.contains('invalid') || two.value.lenght === 0 || three.classList.contains('invalid') || three.value.lenght === 0) {
        alert('error')
    } else {
        dates()
    }
